...
<body>
    <section class="container reg-form-section">
        <form class="row g-3 form-reg" action="" method="">
            ...
            <div id="i-accName" class="form-link mb-2">Already have an account? <a href="invest-login.php">Login Here</a></div>
            <div class="col-12">
